...
namespace CinemaNuMetroV1.Controllers
{
    public class UtilizadoresController : Controller
    {
        ...
        public UtilizadoresController(CinemaNuMetroV1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,email,contacto")] Utilizador utilizador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,nome,email,contacto")] Utilizador utilizador)
        {
            if (id != utilizador.Id)
            {
                return NotFound();
